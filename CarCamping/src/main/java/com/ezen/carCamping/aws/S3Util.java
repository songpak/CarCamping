package com.ezen.carCamping.aws;
...
//Amazon Server와 Connect하여 상호작용하기 위한 공통적인 메서드 생성
public class S3Util {

	private String accessKey = "AKIA2B4KF5WVWWGZ7R23"; // 엑세스 키
	private String secretKey = "UvCFScEKeKNSn0C2AaABYfa5bd1tRdefYUGo4XB5"; // 보안 엑세스 키
