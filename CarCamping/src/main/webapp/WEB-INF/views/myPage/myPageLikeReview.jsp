...
<!-- 		<div class="col" align="right">
		...
		<div class="col" align="left">
			<button type="button" class="btn btn-primary" onclick = "location.href ='myPageLikeReview.myPage?mem_num=${mem_num}'">용품 리뷰</button>
			<button type="button" class="btn btn-primary" onclick = "location.href ='myPageLikeReview.myPage?mem_num=${mem_num}'">장소 리뷰</button>
		...
		<div class="col" align="right">
			<div class="btn-group">
				<button type="button" class="btn btn-primary dropdown-toggle"
					data-bs-toggle="dropdown" aria-expanded="false" style=" border-top-width: 0px;border-bottom-width: 0px; padding-bottom: 6px;
    bottom: 43px;">정렬</button>
...
<!-- 					<div class="modal-body">
	...
	<table class="table table-borderless">
	 <c:forEach items="${list}" var="rpdto">
	 <c:if test="${i%j == 0 }">
		<tr>
		 </c:if>
			<td>
				<div class="card" style="width: 18rem;">
					...
					<div class="card-body">
						...
						<p class="card-text">
							<label for="disabledRange" class="form-label">${rpdto.score}</label> <input
								type="range" class="form-range" id="disabledRange" disabled>
							${rpdto.rp_readCount}|${rpdto.rp_likeCount}<br>
							작성일자<br>
							${rpdto.rp_adminConfirm}관리자 승인 여부
						</p>
