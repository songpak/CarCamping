...
<body>
   ...
   <div class="container" align="center" class="col-lg-9 my-4 mb-4 border border-dark rounded-lg">
      ...
      <c:forEach var="dto" items="${listBoard}">
         <tr style = "cursor:pointer;" onClick = " location.href='myPageContactUsView.myPage?question_num=${dto.question_num}' " onMouseOver = " window.status = 'myPageContactUsView.myPage?question_num=${dto.question_num}' " onMouseOut = " window.status = '' " >
            <td align="center">
                  ${dto.question_title}
               </td>
