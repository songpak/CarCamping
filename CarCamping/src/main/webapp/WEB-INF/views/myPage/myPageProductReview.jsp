		...
		<div align="center" id="header">
			<div class="card border-success mb-3"
				...
				<div class="card-header" style="background-color: #83BD75;">
					<h2 style="margin-bottom: 0px;">${rplist.rp_title}</h2>
				</div>
				<div class="card-body">
					...
					<ul class="list-group">
						...
						<li class="list-group-item d-flex justify-content-between align-items-center">
							<h5 style="padding-right: 180px;">별점 (${rplist.rp_score}/5)</h5>
							<div class="container" style="width: 424px;margin-left: 0px;margin-right: 0px;padding-right: 0px;padding-left: 0px;">
								<div class="row">
									<div id="myform">
										<fieldset style="float:right;">
										<c:choose>
				 				<c:when test="${rplist.rp_score >= 1 && rplist.rp_score < 2 }">
				  							<label for="rate1">⭐</label>
				 				</c:when>
				 				<c:when test="${rplist.rp_score >= 2 && rplist.rp_score < 3 }">
				  						<label for="rate1">⭐</label>
				  						<label for="rate2">⭐</label>
				 				</c:when>
								 <c:when test="${rplist.rp_score >= 3 && rplist.rp_score < 4 }">
				  						<label for="rate1">⭐</label>
				  						<label for="rate2">⭐</label>
				  						<label for="rate3">⭐</label>
				 				</c:when>
				 				<c:when test="${rplist.rp_score >= 4 && rplist.rp_score < 5 }">
				  						<label for="rate1">⭐</label>
				  						<label for="rate2">⭐</label>
				  						<label for="rate3">⭐</label>
				  						 <label for="rate4">⭐</label>
				 				</c:when>
				 				<c:when test="${rplist.rp_score eq 5 }">
				  						<label for="rate1">⭐</label>
				  						<label for="rate2">⭐</label>
				  						<label for="rate3">⭐</label>
				  						<label for="rate4">⭐</label>
