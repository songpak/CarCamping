	...
	<div align="center">
		...
		<table class="table table-success table-striped">
			...
			<tr>
				...
				<td>
					<input type="checkbox" name="ccr_toilet">화장실
					<input type="checkbox" name="ccr_restroom">샤워실
					<input type="checkbox" name="ccr_water">수도시설
					<input type="checkbox" name="ccr_market">주변상가
					<input type="checkbox" name="ccr_river">하천
				</td>
			</tr>
			<tr>
				<th>
