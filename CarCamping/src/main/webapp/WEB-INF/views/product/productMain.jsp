...
<div id="doc" class="gm-t7">
					...
					<div class="swiper-wrapper">
					 <c:forEach items="${popList}" var="pdto">
						<div class="swiper-slide">
							<a href="productView.product?prod_num=${pdto.prod_num}"> ${pdto.prod_viewImage1} <br> ${pdto.prod_name}</a><!-- 이부분 수정하시면 됩니다 -->
						</div>
					 </c:forEach>  
  ...
  <path
					...
					<!-- 검색 form -->
					<form class="d-flex" action="goProduct.product" style="width: 500px; height: 40px;" method="post">
						<select name="search">
							<option value="prod_name">상품명</option>
						</select>
						<input class="form-control me-2" type="text"
							name="searchString" placeholder="인기용품을 검색해보세요!"
							aria-label="Search">
