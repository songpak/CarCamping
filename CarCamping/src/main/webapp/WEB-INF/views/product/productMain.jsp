            ...
            <ul class="pagination justify-content-center">
               <c:if test="${rowCount>0 }">
                  <c:if test="${startPage>1}">
                        <li class="page-item">
                        <a class="page-link" onclick="location.href='productMain.product?prod_num=${prod_num}&pageNum=${startPage-1}&mode=${mode}'">
                           Previous</a>
                        </li> 
                  </c:if>
                  <c:forEach var="i" begin="${startPage}" end="${endPage}">
                     <li class="page-item">
                     <a class="page-link" onclick="location.href='productMain.product?prod_num=${prod_num}&pageNum=${i}&mode=${mode}'">
                           <c:out value="${i}" /></a>
                     </li>                  
                   </c:forEach>
                  <c:if test="${endPage < pageCount }">
                     <li class="page-item">
                     <a class="page-link" onclick="location.href='productMain.product?prod_num=${prod_num}&pageNum=${endPage+1}&mode=${mode}'">
                           Next</a>                     
                     </li>
                  </c:if>
               </c:if>   
