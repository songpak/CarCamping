						...
						<ul class="nav">
							...
							<li class="scroll-to-section">
								...
								<div class="offcanvas-header">
									<h5 class="offcanvas-title" id="offcanvasExampleLabel"><b><font color="navy" size="15">내 메뉴</b></font></h5>
								...
								<div class="offcanvas-body">
									...
									<c:if test="${empty mbdto}">	
                                      <img src="sik.jpg" class="card-img rounded-circle"
						                ...
						                <br></br>
										<span style="text-align:center;"><b>${mbdto.mem_nickName}</b></span>
						                </c:if>
										
									</div>
									<div class="list-group" style="margin-bottom: 0px;margin-top: 20px;margin-right: 10px;">
