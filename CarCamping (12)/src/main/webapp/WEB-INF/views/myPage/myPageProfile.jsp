...
<<<<<<< HEAD:CarCamping/src/main/webapp/WEB-INF/views/myPage/myPageProfile.jsp
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
=======
>>>>>>> 정민(로그인):CarCamping (12)/src/main/webapp/WEB-INF/views/myPage/myPageProfile.jsp
<!DOCTYPE html>
<html>
...
<<<<<<< HEAD:CarCamping/src/main/webapp/WEB-INF/views/myPage/myPageProfile.jsp
                        <input type="radio" name="mem_accept_email" value="0" ${getMember.mem_accept_email.equals("0") ? "checked":""}/>동의합니다.
                        </label>
                        <label class="radio-inline">
                        <input type="radio" name="mem_accept_email" value="1" ${getMember.mem_accept_email.equals("1") ? "checked":""}/>동의하지 않습니다.
=======
...
>>>>>>> 정민(로그인):CarCamping (12)/src/main/webapp/WEB-INF/views/myPage/myPageProfile.jsp
                      ...
                      <tr>
                        ...
                        <label class="radio-inline">
<<<<<<< HEAD:CarCamping/src/main/webapp/WEB-INF/views/myPage/myPageProfile.jsp
                        	<input type="radio" name="mem_accept_phone" value="0" ${getMember.mem_accept_phone.equals("0") ? "checked":""}/>동의합니다.
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="mem_accept_phone" value="1" ${getMember.mem_accept_phone.equals("1") ? "checked":""}/>동의하지 않습니다.
=======
...
>>>>>>> 정민(로그인):CarCamping (12)/src/main/webapp/WEB-INF/views/myPage/myPageProfile.jsp
                       ...
                       <tr>
                        ...
                        <label class="radio-inline">
<<<<<<< HEAD:CarCamping/src/main/webapp/WEB-INF/views/myPage/myPageProfile.jsp
                            <input type="radio" name="mem_accept_privacy" value="0" ${getMember.mem_accept_privacy.equals("0") ? "checked":""}/>동의합니다.
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="mem_accept_phone" value="1" ${getMember.mem_accept_privacy.equals("1") ? "checked":""}/>동의하지 않습니다.
=======
